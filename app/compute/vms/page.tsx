  ...
  return (
    <div className="bg-card text-card-foreground border-border border rounded-lg p-6">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <div className="text-center space-y-4 max-w-md">
          <h4 className="text-lg font-medium text-foreground">No Instances Found</h4>
          <div className="text-muted-foreground">
            <p className="text-sm">
              Create and manage all your virtual machine instances from this central location to monitor performance and control resources.{' '}
              <a href="/documentation/instances" className="text-primary hover:underline">
                Learn more
              </a>
            </p>
          </div>
          <div className="flex justify-center pt-2">
            <Button 
              onClick={() => window.location.href = '/compute/vms/instances/create'}
              size="sm"
            >
              Create Instance
            </Button>
