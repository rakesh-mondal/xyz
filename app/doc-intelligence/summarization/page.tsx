...
function DocumentSummarizationSection() {
  return (
    <div className="bg-card text-card-foreground border-border border rounded-lg p-6">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <div className="text-center space-y-4 max-w-md">
          <h4 className="text-lg font-medium text-foreground">No Document Summarizations Found</h4>
          <div className="text-muted-foreground">
            <p className="text-sm">
              Upload your file to generate a summary using advanced AI techniques.{' '}
              <a href="/documentation/document-summarization" className="text-primary hover:underline">
                Learn more
              </a>
            </p>
          </div>
...
export default function SummarizationPage() {
  return (
    <PageLayout 
      ...
      description="Upload your file to generate a summary using advanced AI summarization techniques."
    >
      <DocumentSummarizationSection />
    </PageLayout>
  )
}
