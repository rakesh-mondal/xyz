    ...
    <div className="bg-card text-card-foreground border-border border rounded-lg p-6">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <div className="text-center space-y-4 max-w-md">
          <h4 className="text-lg font-medium text-foreground">No Text Extractions Found</h4>
          <div className="text-muted-foreground">
            <p className="text-sm">
              Seamlessly extract text from documents, scanned files and images using advanced OCR technology.{' '}
              <a href="/documentation/extract-text" className="text-primary hover:underline">
                Learn more
              </a>
            </p>
          </div>
...
export default function ExtractTextPage() {
  return (
    <PageLayout 
      title="Extract Text" 
      description="Seamlessly extract text from documents, scanned files and images using advanced OCR technology."
    >
      <ExtractTextSection />
    </PageLayout>
  )
